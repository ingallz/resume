...
\small{\item{
              ...
              \textbf{Technologies:}{ Django, FastAPI, Spring, Servlet, Node.js, React.js, Fastify, Express.js, Refine, Docker, Caprover, Hasura, Keycloak, Airflow,
                Redis, BeautifulSoup, Selenium } \\ \vspace{3pt}

              \textbf{Hosting/SaaS:}{ AWS, Netlify, Render, Railway } \\ \vspace{3pt}

              \textbf{OS:}{ Window, Ubuntu(Primary OS), Centos} \\ \vspace{3pt}

              \textbf{Others:}{ Git, CI/CD} \\ \vspace{3pt}
...
\vspace{3pt}
\resumeItem{Re-running the microservices system using Eureka and deploying it on the server (Centos) using Nginx.}
\vspace{3pt}
...
\resumeSubHeadingListStart
\small{\item{
              \textbf{ICPC ASIA Vietnam Regional 2021:}{ Ranked $39^{th}$ - Third Prize (Mar 2022) $|$ \emph{\href{https://icpc.global/ICPCID/DO3D9RLNRDX8}{\color{red}Link}}} \\ \vspace{3pt}

              \textbf{ICPC ASIA Vietnam Regional 2022:}{ Ranked $40^{th}$. (Dec 2022) $|$ \emph{\href{https://icpc.global/ICPCID/DO3D9RLNRDX8}{\color{red}Link}}} \\ \vspace{3pt}

              \textbf{Vietnamese Olympiad in Informatics for Universities (VOI):}{ Third Prize (Dec 2022) $|$ \emph{\href{https://drive.google.com/file/d/17VevlBhBMuU_wrVzSMOtZyQzstWhlA-Q/view?usp=sharing}{\color{red}Link}}} \\ \vspace{3pt}

              \textbf{ICPC PTIT 2022:}{ Ranked $1^{th}$ - Champion (Oct 2022) $|$ \emph{\href{https://portal.ptit.edu.vn/le-trao-giai-cuoc-thi-lap-trinh-theo-chuan-quoc-te-icpc-icpc-ptit-2022/}{\color{red}Link}}} \\ \vspace{3pt}

              \textbf{CODEKING PTIT 2022:}{ Ranked $3^{th}$. (Sep 2022) $|$ \emph{\href{https://www.facebook.com/ITPTIT/photos/a.679487585460391/5532805340128567/}{\color{red}Link}}} \\ \vspace{3pt}
...
{Samsung's Certificates for DSA and Applications $|$ \emph{\href{https://drive.google.com/file/d/1kNnWVGgaUS-IkM80B9xVpEJmoQGsRhfZ/view?usp=sharing}{\color{red}Link}}}{Oct 2021}{The program equips students with a strong algorithmic foundation for practical problem-solving.}
...
\resumeOrganizationHeading
{PTIT's 2021 IT Olympiad Team}{Aug 2021 -- Dec 2022}{Student Member}
...
\resumeSubHeadingListStart
\small{\item{
              \textbf{Codeforces: }{ \emph{\href{https://codeforces.com/profile/Ignr_h31}{\color{blue}Expert}}} \\ \vspace{3pt}
              \textbf{VNOI: }{ \emph{\href{https://oj.vnoi.info/user/huys31}{\color{blue}Expert}}} \\ \vspace{3pt}
        }}
\resumeSubHeadingListEnd
